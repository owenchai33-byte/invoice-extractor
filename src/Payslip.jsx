...
.ps-pagewrap{font-size:15px;display:flex;gap:1.5em;border-radius:2px;padding:0;align-items:stretch}
.ps-pagewrap .slip{padding:1.5em;box-shadow:0 2px 16px rgba(0,0,0,.12);border-radius:4px;height:24em;overflow:hidden}
.ps-pagewrap .slip-sig{flex:1;display:flex;flex-direction:column}
.ps-pagewrap .sig-bottom{margin-top:auto}
