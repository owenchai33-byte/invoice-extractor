...
import { computeStaffMonth, LS_S, LS_P, LS_SB, LS_PIN, LS_H, SAMPLE_STAFF, fmt, readMonthTs, isStaffHidden } from './Payroll';
...
.ps-bar h1{font-size:15px;font-weight:800;letter-spacing:.04em;margin:0;color:#18181b}
