...
export const CJK_LETTERHEAD = cjkLetterhead;   // clean C.J.K. letterhead lifted from the official contract PDF
    ...
    <div className="ext-root" style={{fontFamily:F,fontSize:16,background:'#fff',color:'#000',minHeight:'100vh'}}>
      ...
      <div className="wrap print-area" style={{maxWidth:780,margin:'0 auto',padding:'20px'}}>
        ...
        <div style={{
          ...
          <img src={cjkLetterhead} alt={CO.name} style={{ width:'151mm', maxWidth:'100%', display:'block', margin:'0 auto' }}/>
