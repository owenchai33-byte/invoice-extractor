...
@media print{
  ...
  .ep-page .ep-card{font-size:10.5pt;padding:2mm 5mm;box-sizing:border-box;display:flex;flex-direction:column;overflow:hidden;grid-column:span 2;min-height:0}
  .ep-page .ep-pair{grid-column:span 2;display:flex;gap:1cm;padding:2mm 5mm;box-sizing:border-box;min-height:0;overflow:hidden}
