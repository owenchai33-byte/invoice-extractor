...
.fbar{position:sticky;top:56px;z-index:40;display:flex;align-items:center;gap:10px;background:#fff;border:1px solid #e4e4e7;border-radius:8px;padding:8px 12px;margin-bottom:12px;min-height:22px;box-shadow:0 2px 6px rgba(0,0,0,.08)}
