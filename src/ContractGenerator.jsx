...
- "address": the FULL residential address EXACTLY as printed on the card. On a Malaysian MyKad the address is on the FRONT, below the name (it can be several lines) — read ALL of it and copy it character for character (house/lot number, street, taman/section, postcode, city, state). Join it onto one line. Do NOT paraphrase, reorder, shorten, or invent any part. Only return null if there is genuinely no address visible anywhere on the image (never guess a wrong address).
  ...
  return (
    <>
      ...
      <div className="contract-page" style={pageStyle}>
        <div style={{ paddingBottom: 4, marginBottom: 28 }}>
